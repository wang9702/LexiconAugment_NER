...
def train(data, save_model_dir, seg=True):
    ...
    for idx in range(data.HP_iteration):
        ...
        gc.collect()
    result_file = os.path.join(data.result_file, 'result.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedset', help='Dir of saved data setting(parameters info)', default="data/save.dset")
    ...
    parser.add_argument('--resultfile', default="result")
    ...
    # 字符向量，基于大规模标准分词后的中文语料库Gigaword使用Word2vec工具训练的向量集合
    char_emb = "./data/NeuralSegmentation/gigaword_chn.all.a2b.uni.ite50.vec"
    bichar_emb = "./data/NeuralSegmentation/gigaword_chn.all.a2b.bi.ite50.vec"
    # 基于CTB 6.0（Chinese Treebank 6.0）语料库训练得到的
    gaz_file = "./data/NeuralSegmentation/ctb.50d.vec"
